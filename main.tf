...
module "rds" {
  source = "git::https://github.com/raghudevopsb77/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/raghudevopsb77/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/raghudevopsb77/tf-module-rabbitmq.git"
